...
def callback(ball_pos):
    ...
    if ball_x < 300:
        ...
        ser.write(bytearray([0xAA, 12, 0x04, lower_baxter,l, h]))
    if ball_x > 340:
        lower_baxter_pos += 9
    ...
    if ball_y > 260:
        ...
        ser.write(bytearray([0xAA, 12, 0x04, upper_baxter,l, h]))
    if ball_y < 220:
        upper_baxter_pos += 9
...
if __name__ == '__main__':
    ...
    # pos_init = pololu_set_target(1500)
    ...
    # ser.write(bytearray([0xAA, 12, 0x04, upper_baxter,pos_init[0],pos_init[1]])
    # ser.write(bytearray([0xAA, 12, 0x04, lower_baxter,pos_init[0],pos_init[1]])
